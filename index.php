        ...
        <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
            <form class="border shadow-sm p-4 rounded"
               ...
               <div class="row justify content-center" >
                <h2 class="text-center">Traffic Police Login</h2></br><br>
               </div><br>
               ...
               <!-- Email input -->
                ...
                <div class="text-center text-lg-start mt-4 pt-2">
                     ...
                     <p class="small fw-bold mt-2 pt-1 mb-0">Not an Officer?
                     <a href=admin_index.php class="link-danger"> Admin Login </a></p>
                </div>
